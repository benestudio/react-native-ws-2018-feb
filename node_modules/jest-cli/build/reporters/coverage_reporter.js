...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _istanbulLibCoverage;
...
function _load_istanbulLibSourceMaps() {return _istanbulLibSourceMaps = _interopRequireDefault(require('istanbul-lib-source-maps'));}var _jestWorker;
function _load_jestWorker() {return _jestWorker = _interopRequireDefault(require('jest-worker'));}var _base_reporter;
function _load_base_reporter() {return _base_reporter = _interopRequireDefault(require('./base_reporter'));}var _path;
...
function _load_glob() {return _glob = _interopRequireDefault(require('glob'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               */const FAIL_COLOR = (_chalk || _load_chalk()).default.bold.red;const RUNNING_TEST_COLOR = (_chalk || _load_chalk()).default.bold.dim;class CoverageReporter extends (_base_reporter || _load_base_reporter()).default {
    ...
    if (testResult.coverage) {
      ...
      Object.keys(testResult.sourceMaps).forEach(sourcePath => {
        ...
        try {
          ...
          sourcePath);var _coverage$toJSON =
  ...
  {var _this = this;return _asyncToGenerator(function* () {
      yield _this._addUntestedFiles(_this._globalConfig, contexts);var _sourceMapStore$trans =
      _this._sourceMapStore.transformCoverage(
      _this._coverageMap);const map = _sourceMapStore$trans.map,sourceFinder = _sourceMapStore$trans.sourceFinder;
  ...
  {var _this2 = this;return _asyncToGenerator(function* () {
      ...
      contexts.forEach(function (context) {
        ...
        globalConfig.collectCoverageFrom.length)
        {
          ...
          forEach(function (filePath) {return (
              files.push({
                config,
                path: filePath }));});
      ...
      const instrumentation = files.map((() => {var _ref = _asyncToGenerator(function* (fileObj) {
      ...
      const coveredFilesSortedIntoThresholdGroup = coveredFiles.map(file => {
        for (let i = 0; i < numThresholdGroups; i++) {
          ...
          if (filesByGlob[absoluteThresholdGroup] === undefined) {
            filesByGlob[absoluteThresholdGroup] = (_glob || _load_glob()).default.
            sync(absoluteThresholdGroup).
            map(filePath => (_path || _load_path()).default.resolve(filePath));
          }
