...
function _load_child_process() {return _child_process = require('child_process');}var _package;
function _load_package() {return _package = require('../package.json');}var _worker;
function _load_worker() {return _worker = require('./worker');}var _crypto;
function _load_crypto() {return _crypto = _interopRequireDefault(require('crypto'));}var _events;
function _load_events() {return _events = _interopRequireDefault(require('events'));}var _get_mock_name;
...
function _load_get_platform_extension() {return _get_platform_extension = _interopRequireDefault(require('./lib/get_platform_extension'));}var _constants;
...
function _load_module_map() {return _module_map = _interopRequireDefault(require('./module_map'));}var _node;

function _load_node() {return _node = _interopRequireDefault(require('./crawlers/node'));}var _normalize_path_sep;
function _load_normalize_path_sep() {return _normalize_path_sep = _interopRequireDefault(require('./lib/normalize_path_sep'));}var _os;
function _load_os() {return _os = _interopRequireDefault(require('os'));}var _path;
function _load_path() {return _path = _interopRequireDefault(require('path'));}var _sane;
function _load_sane() {return _sane = _interopRequireDefault(require('sane'));}var _jestSerializer;
function _load_jestSerializer() {return _jestSerializer = _interopRequireDefault(require('jest-serializer'));}var _watchman;

function _load_watchman() {return _watchman = _interopRequireDefault(require('./crawlers/watchman'));}var _watchman_watcher;
function _load_watchman_watcher() {return _watchman_watcher = _interopRequireDefault(require('./lib/watchman_watcher'));}var _jestWorker;
function _load_jestWorker() {return _jestWorker = _interopRequireDefault(require('jest-worker'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class HasteMap extends (_events || _load_events()).default {
  ...
  read() {
    ...
    const hasteMap = (_jestSerializer || _load_jestSerializer()).default.readFileSync(this._cachePath);
